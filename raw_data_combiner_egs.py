...
keep_string = 'egs_'  # The string that kept files will contain
files_egs = []
for file in files_all:
    if keep_string in file: files_egs.append(file)
        
# Sort egs files in ascending order of variational parameter v
files_egs.sort()
