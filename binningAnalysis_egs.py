...
def main():
    ...
    #Load data
    file_name = "Data/egs_4_4_9.9763_1.6212_100000.dat" 
    file_name = "Data/egs_10_10_9.9763_1.6212_100000.dat"
    ...
    with open("egserr_%i_%i_%.4f_%.4f_%i.dat"%(L,N,U,v,M),"w+") as data:
        np.savetxt(data,std_errors,delimiter=" ",fmt="%.16f",header="rows: mc_step columns: distance between sites (r=0,1,2,...) // \nBH Parameters: L=%d,N=%d,U=%.4f,v=%.4f,MC_steps=%d (%d after equilibration) "%(L,N,U,v,M,M*(1-equil_time)))
